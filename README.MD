...
- Algoritmo geométrico basado en visibilidad e intersección de segmentos para generar (geo_heuristic.py)
...
### Help
Existe tambien una funcion help y constrol de algunos errores:
````shell
